...
HandEyeTransform::HandEyeTransform(cv::Mat T, HandEyeMode mode)
    : T_{std::move(T)}, mode_{mode}
{}
...
auto HandEyeTransform::pose_camera_to_base(double x, double y, double z,

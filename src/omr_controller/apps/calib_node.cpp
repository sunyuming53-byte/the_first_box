/// calib_node — ROS2 node wrapping the calibration pipeline.
...
using omr_vision::calibration::CameraCalibInput;
using omr_vision::calibration::CameraCalibrator;
...
int main(int argc, char* argv[]) {
    ...
    auto node = std::make_shared<omr_controller::calib::CalibNode>(rclcpp::NodeOptions{});
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}

...
inline auto create_mock_jtc_server(
    rclcpp::Node* node,
...
{
  auto pub =
      node->create_publisher<sensor_msgs::msg::JointState>(topic, rclcpp::QoS(10));
...
inline bool wait_for_action_server(
    rclcpp::Node* node,
    const std::string& name,
